"""Tests for @job decorator with recovery parameter."""
...
def test_recovery_method_is_callable():
    ...
    result = FailingJob.recover(None, {}, DependencyGroup({}), err)
...
def test_recovery_function_signature():
    ...
    @job(recovery=capture_args_recovery)
...
def test_job_without_recovery_uses_default():
    ...
    try:
        ...
        list(NoRecoveryJob.recover(None, {}, DependencyGroup({}), test_error))
